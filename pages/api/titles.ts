...
export default function handler(
  ...
  res.status(200).json([
    ...
    },
    {
      ...
      image:
        "https://media.istockphoto.com/photos/single-family-new-construction-homein-suburb-neighborhood-in-the-picture-id1147674294?k=20&m=1147674294&s=612x612&w=0&h=7eSceNNA1USRkMbTM6DXPl7UGB1kRvHHcdBtehn4SQ=",
      status: "todo",
    },
  ]);
}
